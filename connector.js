   ...
   /**
	...
	sendRequest(callOptions, callback) {        
	  ...
	  if (callOptions.query)
		newuri = this.constructUri(callOptions.serviceNowTable, callOptions.query);
	  else
		newuri = this.constructUri(callOptions.serviceNowTable);
	  /**
